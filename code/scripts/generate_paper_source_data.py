...
FIG3_YEARLY_ROWS = [
    {"year": 2020, "contracts_analyzed": 35326, "contracts_with_alert": 120, "alert_rate_pct": 0.34},
    {"year": 2021, "contracts_analyzed": 53827, "contracts_with_alert": 165, "alert_rate_pct": 0.31},
    {"year": 2022, "contracts_analyzed": 30990, "contracts_with_alert": 129, "alert_rate_pct": 0.42},
...
FIG4_TOP10_ROWS = [
    {"rank": 1, "provider_label": "VECOL SA", "pct_share_total_value": 5.58, "cumulative_pct_share": 5.58},
    {"rank": 2, "provider_label": "HOSMIL", "pct_share_total_value": 5.39, "cumulative_pct_share": 10.97},
    {"rank": 3, "provider_label": "ETICOS U.T. 2020", "pct_share_total_value": 3.48, "cumulative_pct_share": 14.45},
    {"rank": 4, "provider_label": "OPS/OMS Colombia", "pct_share_total_value": 2.66, "cumulative_pct_share": 17.11},
    {"rank": 5, "provider_label": "U. Antioquia", "pct_share_total_value": 2.57, "cumulative_pct_share": 19.68},
    {"rank": 6, "provider_label": "Agencia Atenea", "pct_share_total_value": 2.08, "cumulative_pct_share": 21.76},
    {"rank": 7, "provider_label": "DISCOLMETS SAS", "pct_share_total_value": 1.93, "cumulative_pct_share": 23.69},
    {"rank": 8, "provider_label": "U.T. MEDIPOL 14", "pct_share_total_value": 1.83, "cumulative_pct_share": 25.52},
    {"rank": 9, "provider_label": "POLPHARMA UT", "pct_share_total_value": 1.58, "cumulative_pct_share": 27.10},
    {"rank": 10, "provider_label": "U.T. MEDIPOL 15", "pct_share_total_value": 1.56, "cumulative_pct_share": 28.66},
]

FIG4_LORENZ_ROWS = [
    {"provider_share_pct": 0.0, "cumulative_value_pct": 0.0},
    {"provider_share_pct": 0.002, "cumulative_value_pct": 5.58},
    {"provider_share_pct": 0.006, "cumulative_value_pct": 14.45},
    {"provider_share_pct": 0.02, "cumulative_value_pct": 28.66},
    {"provider_share_pct": 3.0, "cumulative_value_pct": 85.9},
...
SOURCE_FILE_MANIFEST_ROWS = [
    ...
    {"file_name": "Fig4_top10_source_data.csv", "object_type": "figure", "underlies": "Fig 4 provider bar chart", "source_basis": "Frontend verified fallback values consistent with manuscript concentration summary", "notes": "Contains top 10 provider shares and cumulative shares"},
    {"file_name": "Fig4_lorenz_source_data.csv", "object_type": "figure", "underlies": "Fig 4 Lorenz curve", "source_basis": "Frontend verified fallback Lorenz control points consistent with manuscript concentration summary", "notes": "Minimal points used to reproduce the schematic Lorenz display"},
